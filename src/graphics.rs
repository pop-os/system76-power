...
static EMPTY_BYTES: &[u8] = br#""#; // this is to make it easier to have an "empty" spot when generatic config files

const INITRAMFS_HOOK_PATH: &str = "/etc/initramfs-tools/hooks/system76-power";

// all initramfs hooks need to start with this code
...
// for compute and integrated modes
...
impl Graphics {
    ...
    pub fn set_vendor(&self, vendor: &str) -> Result<(), GraphicsDeviceError> {
        ...
        {   // scope block for writing modprobe and initramfs files based on user selection
            ...
            // create File instance for initramfs file
            ...
            // create first part of initramfs file contents
            let hook_boilerplate = INITRAMFS_HOOK_BOILERPLATE;
